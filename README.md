...
The purpose is to get access information from [ScienceDirect](https://www.sciencedirect.com/) database in using web crawler. The codes are primary python-based  and a few matlab and SQL involved. 
