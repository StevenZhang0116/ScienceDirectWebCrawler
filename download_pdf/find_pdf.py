...
# def find_pdf(page_body):
# 	collection = []
# 	# body = ha.test_body(url)
# 	body=page_body
# 	# print(body)
# 	for raw_position in body.find_all("a", href = re.compile(".pdf")):
# 		link = raw_position.get("href")
# 		# print(link)
# 		# print("======")
# 		new_link = "http://www.sciencedirect.com" + link
# 		collection.append(new_link)
# 	return collection

# def find_rawname(page_body):
# 	collection = []
# 	# body = ha.test_body(url)
# 	body=page_body
# 	items=body.find_all("a", href = re.compile("/science/article"))
# 	print(f'[find_rawname]:found a-tag:({len(items)})')

# 	for raw_position in items:
# 		# print(f'[find_rawname]:a-tag({raw_position})')
# 		txt = raw_position.get_text()
# 		# print(f'[find_rawname]:txt({txt})')
# 		collection.append(txt)
# 	# return collection
# 	new_collection = []
# 	for i in range(len(collection)-1):
# 		if collection[i] != "Download PDF" and collection[i+1] == "Download PDF":
# 			new_collection.append(collection[i])
# 			new_collection.append(collection[i+1])
# 		elif collection[i] == "Download PDF" and collection[i-1] != "Download PDF":
# 			pass
# 		else:
# 			new_collection.append(collection[i])
# 			new_collection.append("NOT AVAILABLE")
